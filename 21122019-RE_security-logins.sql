...
1.- See features of login: Instance-->Security-->right botom over "logins"--> New login--> "SQL server authentification"; unselect enforce
password policy.

2.- To asign  features to the new "user"; --> Instance--> right botom over the "User" 
...
3.- Instance--> Databases--> "Go for any database"--> Tables--> "Go for any table"right botom--> Properties--> Explore (general, permisions...)


4.- Copy a database --> right botom over the database--> Tasks--> Copy database.


5.- Right bottom over the Instance--> Activity Monitor--> 
*/